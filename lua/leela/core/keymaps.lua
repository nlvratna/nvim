...
vim.keymap.set("n", "<leader>v", ":bdelete!<CR>", opts) -- close buffer
...
--
--
-- use the vim.diagnostic.get and set the currrent buf using nvim_set_current_buf and use vim.diagnostic.jump ther to get to that
